...
public class ChainController {
    ...
    @ApiOperation(value="查询块")
    @PostMapping("/checkBlockInfo")
    public CommonResp CheckBlock(@RequestBody BlockhashReq blockhashreq) {return ChainService.checkBlockInfo(blockhashreq);}
